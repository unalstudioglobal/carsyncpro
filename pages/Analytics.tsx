...
export const Analytics: React.FC = () => {
  ...
  if (vehicles.length === 0 && !dataLoading) {
      return (
                ...
                <div className="bg-slate-800 rounded-2xl border border-slate-700 overflow-hidden relative">
                    ...
                    <div className="p-6">
                        ...
                        <button 
                            ...
                            className={`w-full font-medium py-4 rounded-xl flex items-center justify-center space-x-2 transition-all active:scale-95 group relative overflow-hidden ${
                                !isPremium 
