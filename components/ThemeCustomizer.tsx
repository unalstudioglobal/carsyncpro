...
export const ThemeCustomizer: React.FC = () => {
  ...
  const accentOptions: { key: ColorAccent; label: string }[] = [
    ...
    { key: 'teal',    label: t('theme.acc_teal')    },
    { key: 'orange',  label: t('theme.acc_orange')  },
    { key: 'pink',    label: t('theme.acc_pink')    },
  ];
  ...
  const themeOptions: { key: AppTheme; label: string; desc: string }[] = [
    ...
    { key: 'light',    label: t('theme.thm_light'),    desc: t('theme.thm_light_desc')    },
    { key: 'ocean',    label: t('theme.thm_ocean'),    desc: t('theme.thm_ocean_desc')    },
  ];
